...
class AuthorsPage:
    def build_page(self) -> PageInfo:
        return PageInfo(
            category=OverViewCategory.AuthorsPage,
            title="Author's Page",
            cards=[
                CardInfo(
                    title="The Rhythm Of A Life",
                    containers=[
                        ContainerInfo(
                            width=10,
                            embed_type=EmbedType.Text,
                            content="""
                                I wrote The Rhythm of a Life while I was in Australia, where I'd unfold my foldable keyboard and type away on my phone in cafes and libraries.
                        ...
                        ContainerInfo(
                            ...
                            content="https://m.media-amazon.com/images/I/611sECwxzsL._SY466_.jpg",
                        ),
                    ],
                ),
                CardInfo(
                    title="My favourite books on writing",
                    containers=[
                        ContainerInfo(
                            width=6,
                            embed_type=EmbedType.Text,
                            content="""
                                While trying to be a writer for a year, I learned the depths of words and story structure.
                        ...
                        ContainerInfo(
                            width=2,
                            embed_type=EmbedType.Image,
                            content="https://m.media-amazon.com/images/I/71nZU-k0pDL._SY466_.jpg",
                        ),
                        ContainerInfo(
                            width=2,
                            embed_type=EmbedType.Image,
                            content="https://m.media-amazon.com/images/I/71FYfIkskdL._SY466_.jpg",
                        ),
                        ContainerInfo(
                            width=2,
                            embed_type=EmbedType.Image,
                            content="https://m.media-amazon.com/images/I/71YA1iiEw7L._SY466_.jpg",
                        ),
                    ],
                ),
            ],
